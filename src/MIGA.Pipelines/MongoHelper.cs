namespace MIGA.Pipelines
{
  ...
  public static class MongoHelper
  {
    ...
    public static void Backup([NotNull] MongoDbDatabase database, [NotNull] string folder)
    {
      ...
      var info = new ProcessStartInfo(ApplicationManager.GetEmbeddedFile("mongo.tools.zip", "MIGA.Pipelines", "mongodump.exe"), arguments)
      {
        CreateNoWindow = true, 
    ...
    public static void Restore([NotNull] string directoryPath, [NotNull] string newDatabaseName)
    {
      ...
      var info = new ProcessStartInfo(ApplicationManager.GetEmbeddedFile("mongo.tools.zip", "MIGA.Pipelines", "mongorestore.exe"), arguments)
      {
        CreateNoWindow = true, 
        WindowStyle = ProcessWindowStyle.Hidden
      };
