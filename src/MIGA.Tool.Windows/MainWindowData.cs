using MIGA.Tool.Windows.MainWindowComponents;
using MIGA.Tool.Windows.MainWindowComponents.Buttons;
using MIGA.Tool.Windows.MainWindowComponents.Groups;
...
namespace MIGA.Tool.Windows
{
  ...
  public static class MainWindowData
  {
      ...
      Groups = new[]
      {
        new GroupDefinition
        {
          ...
          Buttons = new[]
          {
            ...
            {
              Label = "Refresh sites",
              Image = "/Images/$lg/refresh.png, MIGA.Tool.Windows",
              ...
              Buttons = new[]
              {
                ...
                {
                  Label = "Refresh sites",
                  Image = "/Images/$sm/refresh.png, MIGA.Tool.Windows",
                  Handler = new RefreshButton("sites")
                },
                new ButtonDefinition
                {
        ...
        new GroupDefinition
        {
          ...
          Buttons = new[]
          {
            new ButtonDefinition
            {
              ...
              Image = "/Images/$lg/add_domain.png, MIGA.Tool.Windows",
            ...
            new ButtonDefinition
            {
              ...
              Image = "/Images/$lg/docker_logo.png, MIGA.Tool.Windows",
              Handler = new InstallContainerButton()
            },
            new ButtonDefinition
            {
              Label = "Import Solution",
              Image = "/Images/$lg/upload.png, MIGA.Tool.Windows",
        ...
        new GroupDefinition
        {
          ...
          Buttons = new[]
          {
            ...
            {
              Label = "Get Sitecore",
              Image = "/Images/$lg/cloud_download.png, MIGA.Tool.Windows",
              Handler = new Download8Button()
            },
            new ButtonDefinition
            {
              Label = "Bundled Tools",
              Image = "/Images/$lg/toolbox.png, MIGA.Tool.Windows",
              Buttons = new[]
              {
                new ButtonDefinition
                {
                  Label = "MIGA Logs",
                  Image = "/Images/$sm/folder_document2.png, MIGA.Tool.Windows",
                  Handler = new OpenSimFolderButton(@"%APPDATA%\Sitecore\Sitrecore Make Installation Great Again\Logs")
                },
                new ButtonDefinition
                {
                  Label = "MIGA Data Folder",
                  Image = "/Images/$sm/folder_window.png, MIGA.Tool.Windows",
                  Handler = new OpenSimFolderButton(@"%APPDATA%\Sitecore\Sitrecore Make Installation Great Again")
                },
                new ButtonDefinition(),
                ...
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$sm/cloud_download.png, MIGA.Tool.Windows",
                  Handler = new Download8Button()
                },
                new ButtonDefinition(),
                new ButtonDefinition
                {
                  Label = "Hosts Editor",
                  Image = "/Images/$sm/modem_earth.png, MIGA.Tool.Windows",
                  Handler = new OpenHostsButton()
                },
                new ButtonDefinition
                {
                  Label = "MS SQL Manager",
                  Image = "/Images/$sm/data.png, MIGA.Tool.Windows",
                ...
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$lg/scroll_refresh.png, MIGA.Tool.Windows",
                  Handler = new UpdateLicenseButton()
                },
                new ButtonDefinition
                {
                  Label = "Multiple Deletion",
                  Image = "/Images/$lg/delete.png, MIGA.Tool.Windows",
                ...
                {
                  Label = "Log Analyzer",
                  Image = "/Images/$lg/zoom_vertical.png, MIGA.Tool.Windows",
                  Handler = new OpenLogsButton()
                },
                new ButtonDefinition
                {
                  Label = "SSPG",
                  Image = "/Images/$lg/package_edit.png, MIGA.Tool.Windows",
                  Handler = new OpenSSPGButton()
                },
                new ButtonDefinition
                {
                  Label = "Config Builder",
                  Image = "/Images/$sm/wrench.png, MIGA.Tool.Windows",
                  Handler = new ConfigBuilderButton()
                },
                new ButtonDefinition
                {
                  Label = "Install Solr",
                  Image = "/Images/$lg/install.png, MIGA.Tool.Windows",
        ...
        new GroupDefinition
        {
          ...
          Buttons = new[]
          {
            ...
            {
              Label = "Settings",
              Image = "/Images/$lg/wrench.png, MIGA.Tool.Windows",
    ...
    private static ButtonDefinition GetVisualStudioButton()
    {
      ...
      {
        Label = "Visual Studio",
        Image = "/Images/$sm/vs.png, MIGA.Tool.Windows",
    ...
    {
      if (!File.Exists(Environment.ExpandEnvironmentVariables("%PROGRAMDATA%\\Sitecore\\Sitrecore Make Installation Great Again\\pss.txt")) && !Directory.Exists(Environment.ExpandEnvironmentVariables("%PROGRAMDATA%\\Sitecore\\NuGet")))
      {
        return null;
      }
      ...
      Groups = new[]
      {
        new GroupDefinition
        {
          ...
          Buttons = new[]
          {
            new ButtonDefinition
            {
              ...
              Image = "/Images/$lg/Sitecore.png, MIGA.Tool.Windows",
              ...
              Buttons = new[]
              {
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$sm/earth2.png, MIGA.Tool.Windows",
                ...
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$sm/log_out.png, MIGA.Tool.Windows",
                ...
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$sm/Windows Table.png, MIGA.Tool.Windows",
                ...
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$sm/Pencil.png, MIGA.Tool.Windows",
                  Handler = new BrowseButton("/sitecore/shell/applications/content%20editor")
                },
                new ButtonDefinition
                {
                  Label = "Page Editor",
                  Image = "/Images/$sm/Paint.png, MIGA.Tool.Windows",
                  Handler = new BrowseButton("/?sc_mode=edit")
                },
                new ButtonDefinition
                {
                  Label = "Launch Pad",
                  Image = "/Images/$sm/startpage.png, MIGA.Tool.Windows",
                ...
                {
                  Label = "Google Chrome",
                  Image = "/Images/$lg/chrome.png, MIGA.Tool.Windows",
                ...
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$lg/firefox.png, MIGA.Tool.Windows",
                ...
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$lg/ie.png, MIGA.Tool.Windows",
                ...
                {
                  Label = "Apple Safari",
                  Image = "/Images/$lg/safari.png, MIGA.Tool.Windows",
            ...
            {
              Label = "Log in admin",
              Image = "/Images/$lg/log_in.png, MIGA.Tool.Windows",
              ...
              Buttons = new[]
              {
                ...
                {
                  Label = "Copy URL",
                  Image = "/Images/$lg/astrologer.png, MIGA.Tool.Windows",
        ...
        new GroupDefinition
        {
          ...
          Buttons = new[]
          {
            new ButtonDefinition
            {
              ...
              Image = "/Images/$lg/folder_open.png, MIGA.Tool.Windows",
            ...
            new ButtonDefinition
            {
              ...
              Buttons = new[]
              {
                ...
                {
                  Label = "Root Folder",
                  Image = "/Images/$sm/folder_network.png, MIGA.Tool.Windows",
                ...
                {
                  Label = "Website Folder",
                  Image = "/Images/$sm/folder_open.png, MIGA.Tool.Windows",
                  Handler = new SitecoreMemberOpenFolderButton("$(website)")
                },
                new ButtonDefinition
                {
                  Label = "Data Folder",
                  Image = "/Images/$sm/folders.png, MIGA.Tool.Windows",
            ...
            {
              Label = "Config Files",
              Image = "/Images/$lg/copy.png, MIGA.Tool.Windows",
              ...
              Buttons = new[]
              {
                ...
                {
                  Label = "web.config",
                  Image = "/Images/$sm/document_text.png, MIGA.Tool.Windows",
                  Handler = new OpenWebConfigButton()
                },
                new ButtonDefinition(),
                new ButtonDefinition
                ...
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$sm/data_copy.png, MIGA.Tool.Windows",
                ...
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$sm/document_gear.png, MIGA.Tool.Windows",
            ...
            {
              Label = "Log Files",
              Image = "/Images/$lg/history2.png, MIGA.Tool.Windows",
              ...
              Buttons = new[]
              {
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$sm/console.png, MIGA.Tool.Windows",
        ...
        new GroupDefinition
        {
          ...
          Buttons = new[]
          {
            ...
            {
              Label = "Visual Studio",
              Image = "/Images/$lg/vs.png, MIGA.Tool.Windows",
              Handler = new OpenVisualStudioButton(),
              Buttons = new[]
              {
                GetVisualStudioButton(),
      ...
      Groups = new[]
      {
        ...
        new GroupDefinition
        {
          ...
          Buttons = new[]
          {
            ...
            {
              Label = "Backup",
              Image = "/Images/$lg/floppy_disks.png, MIGA.Tool.Windows",
              ...
              Buttons = new[]
              {
                ...
                {
                  Label = "Backup",
                  Image = "/Images/$sm/box_into.png, MIGA.Tool.Windows",
                  Handler = new BackupInstanceButton()
                },
                new ButtonDefinition
                {
                  Label = "Export",
                  Image = "/Images/$lg/download.png, MIGA.Tool.Windows",
            ...
            {
              Label = "Restore",
              Image = "/Images/$lg/box_out.png, MIGA.Tool.Windows",
    ...
    {
      if (!File.Exists(
        Environment.ExpandEnvironmentVariables("%PROGRAMDATA%\\Sitecore\\Sitrecore Make Installation Great Again\\extra.txt")))
      {
        return new GroupDefinition
        {
          ...
          Buttons = new[]
          {
            ...
            {
              Label = "App State",
              Image = "/Images/$lg/gearwheels.png, MIGA.Tool.Windows",
              ...
              Buttons = new[]
              {
                ...
                {
                  Label = "Start",
                  Image = "/Images/$sm/media_play.png, MIGA.Tool.Windows",
                  Handler = new ControlAppPoolButton("start")
                },
                new ButtonDefinition
                {
                  Label = "Stop",
                  Image = "/Images/$sm/media_stop.png, MIGA.Tool.Windows",
                ...
                {
                  Label = "Recycle",
                  Image = "/Images/$sm/garbage.png, MIGA.Tool.Windows",
                  Handler = new ControlAppPoolButton("recycle")
                },
                new ButtonDefinition
                {
                  Label = "Kill process",
                  Image = "/Images/$sm/cpu.png, MIGA.Tool.Windows",
            ...
            {
              Label = "Delete",
              Image = "/Images/$lg/uninstall.png, MIGA.Tool.Windows",
              ...
              Buttons = new[]
              {
                ...
                {
                  Label = "Delete",
                  Image = "/Images/$sm/uninstall.png, MIGA.Tool.Windows",
                  Handler = new DeleteInstanceButton()
                },
                new ButtonDefinition
                {
                  Label = "Reinstall",
                  Image = "/Images/$sm/redo.png, MIGA.Tool.Windows",
            ...
            {
              Label = "Extra Actions",
              Image = "/Images/$lg/atom2.png, MIGA.Tool.Windows",
              ...
              Buttons = new[]
              {
                new ButtonDefinition
                {
                  ...
                  Image = "/Images/$sm/publish.png, MIGA.Tool.Windows",
    ...
    {
      new ButtonDefinition { Label = "Browse Sitecore Container Website", Image = "/Images/$sm/earth2.png, MIGA.Tool.Windows", Handler = new BrowseSitecoreContainerWebsiteButton() },
      new ButtonDefinition { Label = "Browse Website", Image = "/Images/$sm/earth2.png, MIGA.Tool.Windows", Handler = new BrowseHomePageButton() },
      new ButtonDefinition { Label = "Browse Sitecore Client", Image = "/Images/$sm/Sitecore.png, MIGA.Tool.Windows", Handler = new BrowseButton("/sitecore") },
      new ButtonDefinition { Label = "Log in admin", Image = "/Images/$sm/log_in.png, MIGA.Tool.Windows", Handler = new LoginAdminButton("/sitecore"), Buttons = new [] {
        new ButtonDefinition { Label = "Google Chrome", Image = "/Images/$lg/chrome.png, MIGA.Tool.Windows", Handler = new LoginAdminButton("/sitecore:chrome") },
        new ButtonDefinition { Label = "Mozilla Firefox", Image = "/Images/$lg/firefox.png, MIGA.Tool.Windows", Handler = new LoginAdminButton("/sitecore:firefox") },
        new ButtonDefinition { Label = "Internet Explorer", Image = "/Images/$lg/ie.png, MIGA.Tool.Windows", Handler = new LoginAdminButton("/sitecore:iexplore") },
        new ButtonDefinition { Label = "Apple Safari", Image = "/Images/$lg/safari.png, MIGA.Tool.Windows", Handler = new LoginAdminButton("/sitecore:safari") },
        new ButtonDefinition { Handler = new OpenToolboxButton() },
        new ButtonDefinition { Label = "Sitecore Admin", Image = "/Images/$lg/toolbox.png, MIGA.Tool.Windows", Handler = new OpenToolboxButton("bypass") },
        new ButtonDefinition { Handler = new LoginAdminButton() },
        new ButtonDefinition { Label = "Copy URL", Image = "/Images/$lg/astrologer.png, MIGA.Tool.Windows", Handler = new LoginAdminButton("$(clipboard)") },
      }}, 
      new ButtonDefinition { Label = "Sitecore Admin", Image = "/Images/$lg/toolbox.png, MIGA.Tool.Windows", Handler = new OpenToolboxButton() },
      new ButtonDefinition { Label = "Open Folder", Image = "/Images/$sm/folder_open.png, MIGA.Tool.Windows", Handler = new OpenFolderButton("$(website)") },
      new ButtonDefinition { Label = "Open Container Folder", Image = "/Images/$sm/folder_open.png, MIGA.Tool.Windows", Handler = new OpenContainerFolderButton() },
      new ButtonDefinition { Label = "Open Visual Studio", Image = "/Images/$sm/vs.png, MIGA.Tool.Windows", Handler = new OpenVisualStudioButton() },
      new ButtonDefinition { Handler = new OpenWebConfigButton() },
      new ButtonDefinition { Label = "Analyze log files", Image = "/Images/$lg/zoom_vertical.png, MIGA.Tool.Windows", Handler = new OpenLogsButton() },
      new ButtonDefinition { Label = "Open log file", Image = "/Images/$sm/console.png, MIGA.Tool.Windows", Handler = new OpenCurrentLogButton() },
      new ButtonDefinition { Label = "Open web.config file", Image = "/Images/$sm/document_text.png, MIGA.Tool.Windows", Handler = new OpenWebConfigButton() },
      new ButtonDefinition { Handler = new PublishButton() },
      new ButtonDefinition { Label = "Publish Site", Image = "/Images/$sm/publish.png, MIGA.Tool.Windows", Handler = new PublishButton() },
      new ButtonDefinition { Handler = new BackupInstanceButton() },
      new ButtonDefinition { Label = "Backup", Image = "/Images/$sm/box_into.png, MIGA.Tool.Windows", Handler = new BackupInstanceButton() },
      new ButtonDefinition { Label = "Restore", Image = "/Images/$sm/box_out.png, MIGA.Tool.Windows", Handler = new RestoreInstanceButton() },
      new ButtonDefinition { Handler = new ExportInstanceButton() },
      new ButtonDefinition { Label = "Export", Image = "/Images/$sm/download.png, MIGA.Tool.Windows", Handler = new ExportInstanceButton() },
      new ButtonDefinition { Handler = new InstallModulesButton() },
      new ButtonDefinition { Label = "Install modules", Image = "/Images/$sm/install.png, MIGA.Tool.Windows", Handler = new InstallModulesButton() },
      new ButtonDefinition { Handler = new ReinstallInstanceButton() },
      new ButtonDefinition { Label = "Reinstall instance", Image = "/Images/$sm/redo.png, MIGA.Tool.Windows", Handler = new ReinstallInstanceButton() },
      new ButtonDefinition { Handler = new DeleteInstanceButton() },
      new ButtonDefinition { Label = "Delete", Image = "/Images/$sm/uninstall.png, MIGA.Tool.Windows", Handler = new DeleteInstanceButton() },
    };
