namespace MIGA.Tool.Windows
{
  ...
  <pipelines>
    <download8 title=""Downloading Sitecore"">
      <processor type=""MIGA.Tool.Windows.Pipelines.Download8.Download8Processor, MIGA.Tool.Windows""
                  title=""Downloading packages"" />
    </download8>
  </pipelines>
  <wizardPipelines>
    <agreement title=""MIGA License Agreement"" startButton=""Accept"" finishText=""Thank you"">
      <steps afterLastStep=""MIGA.Tool.Windows.SaveAgreement, MIGA.Tool.Windows"">
        <step name=""Welcome message"" type=""MIGA.Tool.Windows.UserControls.ConfirmStepUserControl, MIGA.Tool.Windows""
              param=""PLEASE READ IT CAREFULLY! You can see this wizard because it is the first time Sitrecore Make Installation Great Again was executed in this user account after installation or update. You should accept license agreement to use it. It was taken from http://marketplace.sitecore.net and most likely you already accepted it before downloading, but just in case please do it again here."" />
        <step name=""License agreement from marketplace.sitecore.net""
              type=""MIGA.Tool.Windows.UserControls.ConfirmStepUserControl, MIGA.Tool.Windows""
...
By clicking 'Accept' you accept the License Agreement."" />
    ...
    <setup title=""Initial Configuration Wizard"" startButton=""Next""
           ...
           cancelButton=""Exit"">
      <steps afterLastStep=""MIGA.Tool.Windows.Pipelines.Setup.SetupProcessor, MIGA.Tool.Windows"">
        <step name=""Welcome message"" type=""MIGA.Tool.Windows.UserControls.ConfirmStepUserControl, MIGA.Tool.Windows""
              param=""PLEASE READ IT CAREFULLY! You can see this wizard because it is the first time Sitrecore Make Installation Great Again (MIGA) was executed in this user account. You should accept license agreement and then set your preferences before you can use it, this wizard will help you.
...
PLEASE NOTE that all your application settings and log files are stored in your personal folder (%APPDATA%\Sitecore\Sitrecore Make Installation Great Again) so that other users of this PC will not see, use or change your setting details. "" />
        <step name=""License agreement from marketplace.sitecore.net""
              type=""MIGA.Tool.Windows.UserControls.ConfirmStepUserControl, MIGA.Tool.Windows""
              param=""YOU SHOULD CAREFULLY READ THE FOLLOWING TERMS AND CONDITIONS BEFORE USING THIS SOFTWARE (THE “SITECORE SOFTWARE”). ANY USE OF THE SITECORE SOFTWARE IS SUBJECT TO YOUR FULL ACCEPTANCE OF THIS LICENSE AGREEMENT.
...
By clicking 'Next' you accept the License Agreement."" />
        <step name=""Instances Root Folder"" type=""MIGA.Tool.Windows.UserControls.Setup.InstancesRoot, MIGA.Tool.Windows"" />
        <step name=""Local Repository and Sitecore License""
              type=""MIGA.Tool.Windows.UserControls.Setup.LocalRepository, MIGA.Tool.Windows"" />

        <step name=""SQL Server Connection String""
              type=""MIGA.Tool.Windows.UserControls.Setup.ConnectionString, MIGA.Tool.Windows"" />
        <step name=""File System permissions"" type=""MIGA.Tool.Windows.UserControls.Setup.Permissions, MIGA.Tool.Windows"" />
      </steps>
    </setup>
    ...
    <download8 title=""Download Sitecore Wizard"" startButton=""Next"" finishText=""Done"" cancelButton=""Exit"">
      <steps>
        <step name=""Welcome message"" type=""MIGA.Tool.Windows.UserControls.ConfirmStepUserControl, MIGA.Tool.Windows""
              param=""This wizard helps you to download packages ('ZIP archive of the Sitecore CMS site root') of the Sitecore CMS versions that Sitrecore Make Installation Great Again will be able to install for you. It will require your credentials from dev.sitecore.net because all downloads are protected from being downloaded by anonymous users. 
...
By clicking 'Next' you accept the License Agreement."" />
        <step name=""Choose versions to download""
              type=""MIGA.Tool.Windows.UserControls.Download8.Downloads, MIGA.Tool.Windows"" />
        <step name=""Provide your dev.sitecore.net credentials""
              type=""MIGA.Tool.Windows.UserControls.Download8.Login, MIGA.Tool.Windows""
    ...
    <installSolr title=""Installing new Solr instance"" startButton=""Install""
          ...
          <args type=""MIGA.Tool.Base.Pipelines.Install9WizardArgs, MIGA.Tool.Base""/>
          <steps>
            <step name=""STEP 1 of 2 - DETAILS"" 
                  type=""MIGA.Tool.Windows.UserControls.Install.SolrDetails, MIGA.Tool.Windows"" />
            <step name=""STEP 2 of 2 - SELECT INSTALLATION TASKS"" 
                  type=""MIGA.Tool.Windows.UserControls.Install.Instance9SelectTasks, MIGA.Tool.Windows"" />
         </steps> 
      <finish>
         <action text=""Add this solr to MIGA"" type=""MIGA.Tool.Windows.Pipelines.Solr.AddSolrToSimConfig, MIGA.Tool.Windows"" method=""Run"" />
      </finish>
     </installSolr>
...
<delete9 title=""Deleting instances"" startButton=""Delete""
      ...
      <steps>
        <step name=""STEP 1 of 2 - DETAILS"" 
              type=""MIGA.Tool.Windows.UserControls.Install.Delete9Details, MIGA.Tool.Windows"" />
        <step name=""STEP 2 of 2 - SELECT UNINSTALLATION TASKS"" 
              type=""MIGA.Tool.Windows.UserControls.Install.Instance9SelectTasks, MIGA.Tool.Windows"" />        
     </steps>     
     <finish>
         <hive type=""MIGA.Tool.Windows.Pipelines.Install.Install9ActionsHive, MIGA.Tool.Windows"" />
     </finish>
    </delete9>
    <reinstall9 title=""Reinstalling {InstanceName}"" startButton=""Reinstall""
      ...
      <args type=""MIGA.Tool.Base.Pipelines.ReinstallWizardArgs, MIGA.Tool.Base""/>
      <steps>
        <step name=""Confirmation"" 
              type=""MIGA.Tool.Windows.UserControls.Reinstall.Reinstall9Confirmation, MIGA.Tool.Windows"" />       
     </steps>  
    </reinstall9>
    <install9 title=""Installing new instance"" startButton=""Install""
      ...
      <steps>
        <step name=""STEP 1 of 3 - DETAILS"" 
              type=""MIGA.Tool.Windows.UserControls.Install.Instance9Details, MIGA.Tool.Windows"" />
        <step name=""STEP 2 of 3 - SELECT INSTALLATION TASKS"" 
              type=""MIGA.Tool.Windows.UserControls.Install.Instance9SelectTasks, MIGA.Tool.Windows"" />
<step name=""STEP 3 of 3 - PARAMETERS VALIDATION"" 
              type=""MIGA.Tool.Windows.UserControls.Install.Instance9Validation, MIGA.Tool.Windows"" />
     </steps>   
     <finish>
         <hive type=""MIGA.Tool.Windows.Pipelines.Install.Install9ActionsHive, MIGA.Tool.Windows"" />
     </finish>
    ...
    <installContainer title=""Installing new instance"" startButton=""Install""
      ...
      <steps>
        <step name=""STEP 1 of 2 - DETAILS"" 
              type=""MIGA.Tool.Windows.UserControls.Install.Containers.ContainerDetails, MIGA.Tool.Windows"" />
        <step name=""STEP 2 of 2 - SELECT TOPOLOGY AND TAG"" 
              type=""MIGA.Tool.Windows.UserControls.Install.Containers.SelectTag, MIGA.Tool.Windows"" />
     </steps>   
    </installContainer>
    <deleteContainer title=""Deleting the environment"" startButton=""Delete""
             finishText=""The deleting was successfully completed"">
      <args type=""MIGA.Tool.Base.Pipelines.DeleteContainersWizardArgs, MIGA.Tool.Base""/>
      <steps>
        <step name=""STEP 1 of 1 - DETAILS"" 
              type=""MIGA.Tool.Windows.UserControls.Delete.Containers.DeleteDetails, MIGA.Tool.Windows"" />
     </steps>           
    </deleteContainer>
    <reinstallContainer title=""Reinstalling the instance"" startButton=""Reinstall""
      ...
      <steps>
        <step name=""STEP 1 of 1 - DETAILS"" 
              type=""MIGA.Tool.Windows.UserControls.Reinstall.Containers.ReinstallDetails, MIGA.Tool.Windows"" />
     </steps>   
    </reinstallContainer>
    <install title=""Installing new instance"" startButton=""Install""
      ...
      <steps>
        <step name=""STEP 1 of 7 - DETAILS"" 
              type=""MIGA.Tool.Windows.UserControls.Install.InstanceDetails, MIGA.Tool.Windows"" />
        <step name=""STEP 2 of 7 - TWEAKS"" 
              type=""MIGA.Tool.Windows.UserControls.Install.InstanceSettings, MIGA.Tool.Windows"" />
        <step name=""STEP 3 of 7 - CONFIGURATION ROLES"" 
              type=""MIGA.Tool.Windows.UserControls.Install.InstanceRole, MIGA.Tool.Windows"" />
        <step name=""STEP 3 of 7 - CONFIGURATION ROLES"" 
              type=""MIGA.Tool.Windows.UserControls.Install.InstanceRole9, MIGA.Tool.Windows"" />
        <step name=""STEP 4 of 7 - OFFICIAL SITECORE MODULES"" 
              type=""MIGA.Tool.Windows.UserControls.Install.Modules.ModulesDetails, MIGA.Tool.Windows"" />
        <step name=""STEP 5 of 7 - CUSTOM PACKAGES AND ZIP FILES""
              type=""MIGA.Tool.Windows.UserControls.Install.Modules.FilePackages, MIGA.Tool.Windows"" />
        <step name=""STEP 6 of 7 - CONFIGURATION PRESETS""
              type=""MIGA.Tool.Windows.UserControls.Install.Modules.ConfigurationPackages, MIGA.Tool.Windows"" />
        <step name=""STEP 7 of 7 - REVIEW, REARRANGE INSTALLATION ORDER OR ADD CUSTOM PACKAGE""
          type=""MIGA.Tool.Windows.UserControls.Install.Modules.ReorderPackages, MIGA.Tool.Windows"" />
      </steps>
      <finish>
        <action text=""Open in Browser"" type=""MIGA.Tool.Windows.Pipelines.Install.InstallActions, MIGA.Tool.Windows""
                method=""OpenBrowser"" />
        <action text=""Open in Browser (Sitecore Client)""
                type=""MIGA.Tool.Windows.Pipelines.Install.InstallActions, MIGA.Tool.Windows"" method=""OpenSitecoreClient"" />
        <action text=""Open in Browser (Sitecore Client; Log in as Admin)""
                type=""MIGA.Tool.Windows.Pipelines.Install.InstallActions, MIGA.Tool.Windows"" method=""LoginAdmin"" />
        <action text=""Open folder"" type=""MIGA.Tool.Windows.Pipelines.Install.InstallActions, MIGA.Tool.Windows""
                method=""OpenWebsiteFolder"" />
        <action text=""Open Visual Studio"" type=""MIGA.Tool.Windows.Pipelines.Install.InstallActions, MIGA.Tool.Windows""
                method=""OpenVisualStudio"" />
        <action text=""Make a back up"" type=""MIGA.Tool.Windows.Pipelines.Install.InstallActions, MIGA.Tool.Windows""
                method=""BackupInstance"" />
        <action text=""Publish Site"" type=""MIGA.Tool.Windows.Pipelines.Install.InstallActions, MIGA.Tool.Windows"" method=""PublishSite"" />
        <hive type=""MIGA.Tool.Windows.Pipelines.Install.InstallModulesFinishActionHive, MIGA.Tool.Windows"" />
      </finish>
    </install>
    <delete title=""Deleting the {InstanceName} instance"" startButton=""Delete""
            finishText=""The deleting was successfully completed"">
      <steps>
        <step name=""Information"" type=""MIGA.Tool.Windows.UserControls.ConfirmStepUserControl, MIGA.Tool.Windows""
...
* - the SQL Server instance specified by connection string in the Settings dialog"" />
        <step name=""Select the instances that you want to delete""
              type=""MIGA.Tool.Windows.UserControls.MultipleDeletion.SelectInstances, MIGA.Tool.Windows"" />
        <step name=""Confirmation"" type=""MIGA.Tool.Windows.UserControls.ConfirmStepUserControl, MIGA.Tool.Windows""
    ...
    <backup title=""Backing up the {InstanceName} instance"" startButton=""Backup""
      ...
      <steps>
        ...
        <step name=""Specify the backup name and and select the necessary resources""
              type=""MIGA.Tool.Windows.UserControls.Backup.BackupSettings, MIGA.Tool.Windows"" />
      </steps>
    </backup>
    <restore title=""Restoring up the {InstanceName} instance"" startButton=""Restore""
      ...
      <steps>
        <step name=""Choose backup"" type=""MIGA.Tool.Windows.UserControls.Backup.ChooseBackup, MIGA.Tool.Windows"" />
      </steps>
    </restore>
...
• assembling zip package"" />
        <step name=""Choose the databases for exporting""
              type=""MIGA.Tool.Windows.UserControls.Export.ExportDatabases, MIGA.Tool.Windows"" />
        <step name=""Specify path and name for the export file""
              type=""MIGA.Tool.Windows.UserControls.Export.ExportFile, MIGA.Tool.Windows"" />
      </steps>
      <finish>
        <action text=""Open folder"" type=""MIGA.Tool.Windows.UserControls.Export.FinishActions, MIGA.Tool.Windows""
...
• importing IIS website and Application Pool "" />
        <step name=""Specify root path and website name""
              type=""MIGA.Tool.Windows.UserControls.Import.ImportWebsite, MIGA.Tool.Windows"" />
        <step name=""Change site bindings if needed""
              type=""MIGA.Tool.Windows.UserControls.Import.SetWebsiteBindings, MIGA.Tool.Windows"" />
      </steps>
    </import>
...
* - the SQL Server instance specified by connection string in the Settings dialog"" />
      ...
      <finish>
        <action text=""Open in Browser"" 
                type=""MIGA.Tool.Windows.Pipelines.Reinstall.FinishActions, MIGA.Tool.Windows"" method=""OpenBrowser"" />

        <action text=""Open in Browser (Sitecore Client)""
                type=""MIGA.Tool.Windows.Pipelines.Reinstall.FinishActions, MIGA.Tool.Windows"" method=""OpenSitecoreClient"" />

        <action text=""Open in Browser (Sitecore Client; Login as Admin)""
                type=""MIGA.Tool.Windows.Pipelines.Reinstall.FinishActions, MIGA.Tool.Windows"" method=""LoginAdmin"" />

        <action text=""Open folder"" 
                type=""MIGA.Tool.Windows.Pipelines.Reinstall.FinishActions, MIGA.Tool.Windows"" method=""OpenWebsiteFolder"" />

        <action text=""Open Visual Studio"" 
                type=""MIGA.Tool.Windows.Pipelines.Reinstall.FinishActions, MIGA.Tool.Windows"" method=""OpenVisualStudio"" />
    ...
    <installmodules title=""Installing modules to the {InstanceName} instance"" startButton=""Install""
      ...
      <finish>
        <action text=""Open in Browser"" type=""MIGA.Tool.Windows.Pipelines.Install.InstallModulesActions, MIGA.Tool.Windows""
                method=""OpenBrowser"" />
        <action text=""Open in Browser (Sitecore Client)""
                type=""MIGA.Tool.Windows.Pipelines.Install.InstallModulesActions, MIGA.Tool.Windows"" method=""OpenSitecoreClient"" />
        <action text=""Open in Browser (Sitecore Client; Login as Admin)""
                type=""MIGA.Tool.Windows.Pipelines.Install.InstallModulesActions, MIGA.Tool.Windows"" method=""LoginAdmin"" />
        <action text=""Open folder"" type=""MIGA.Tool.Windows.Pipelines.Install.InstallModulesActions, MIGA.Tool.Windows""
                method=""OpenWebsiteFolder"" />
        <action text=""Open Visual Studio"" type=""MIGA.Tool.Windows.Pipelines.Install.InstallModulesActions, MIGA.Tool.Windows""
                method=""OpenVisualStudio"" />
        <action text=""Publish Site"" type=""MIGA.Tool.Windows.Pipelines.Install.InstallModulesActions, MIGA.Tool.Windows"" method=""PublishSite"" />
        <hive type=""MIGA.Tool.Windows.Pipelines.Install.InstallModulesFinishActionHive, MIGA.Tool.Windows"" />
      </finish>
    </installmodules>
  </wizardPipelines>
