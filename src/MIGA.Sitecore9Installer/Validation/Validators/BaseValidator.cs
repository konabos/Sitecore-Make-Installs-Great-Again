...
namespace MIGA.Sitecore9Installer.Validation.Validators
{
  public abstract class BaseValidator : IValidator
  {
    ...
    public virtual IEnumerable<ValidationResult> Evaluate(IEnumerable<Tasks.Task> tasks)
    {
    ...
    protected abstract IEnumerable<ValidationResult> GetErrorsForTask(Tasks.Task task, IEnumerable<InstallParam> paramsToValidate);
