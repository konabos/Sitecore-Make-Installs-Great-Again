using MIGA.Core;
using MIGA.Tool.Base.Windows.Dialogs;
...
namespace MIGA.Tool.Base
{
  ...
  public static class WindowHelper
  {
    ...
    public static string PickFile([NotNull] string message, [CanBeNull] System.Windows.Controls.TextBox textBox, [CanBeNull] System.Windows.Controls.Control otherControl, [NotNull] string pattern)
    {
      ...
      if (!string.IsNullOrEmpty(fileName) && MIGA.FileSystem.FileSystem.Local.File.Exists(filePath))
      {
    ...
    public static void PickFolder([NotNull] string message, [NotNull] System.Windows.Controls.TextBox textBox, [CanBeNull] System.Windows.Controls.Control otherControl, string initialPath = null)
    {
      ...
      {
        if (!string.IsNullOrEmpty(path) && MIGA.FileSystem.FileSystem.Local.Directory.Exists(path))
        {
    ...
    {
      return System.Windows.MessageBox.Show(message, "Sitrecore Make Installation Great Again");
    }
    ...
    {
      return System.Windows.MessageBox.Show(message, "Sitrecore Make Installation Great Again", messageBoxButton, messageBoxImage);
    }
    ...
    {
      return System.Windows.MessageBox.Show(message, "Sitrecore Make Installation Great Again", messageBoxButton, messageBoxImage, messageBoxResult);
    }
