namespace MIGA
{
  public static class AdvancedSettings
  {
    ...
    /// <summary>
    ///   Creates and registers advanced setting stored in %AppData%/Sitecore/Sitrecore Make Installation Great Again/AdvancedSettings.xml
    ///   file
    /// </summary>
    ...
    /// <summary>
    ///   Creates and registers String advanced setting stored in %AppData%/Sitecore/Sitecore Instance
    ///   Manager/AdvancedSettings.xml file
    /// </summary>
    /// <param name="xPathKey">Key of the setting in a form of xpath expression</param>
    /// <param name="defaultValue">Default value of the setting</param>
    /// <returns></returns>
    ...
    /// <summary>
    ///   Creates and registers Boolean advanced setting stored in %AppData%/Sitecore/Sitecore Instance
    ///   Manager/AdvancedSettings.xml file
    /// </summary>
    /// <param name="xPathKey">Key of the setting in a form of xpath expression</param>
    /// <param name="defaultValue">Default value of the setting</param>
