  ...
  public static class Analytics
  {
    ...
    public static void Start()
    {
      ...
      try
      {
        ...
        configuration.TelemetryChannel = new PersistenceChannel("Sitrecore Make Installation Great Again");
    ...
    public static string GetCookie()
    {
      ...
      if (Directory.Exists(tempFolder))
      {
        ...
        {
          var cookie = FileSystem.FileSystem.Local.File.ReadAllText(path);
      ...
      try
      {
        FileSystem.FileSystem.Local.File.WriteAllText(path, newCookie);
      }
      catch (Exception ex)
      {
